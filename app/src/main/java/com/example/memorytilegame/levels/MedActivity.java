...
import com.example.memorytilegame.levels.HardActivity;

import java.util.Stack;

public class MedActivity extends AppCompatActivity {

    ImageView img1, img2, img3, img4, img5, img6, img7, img8, img9, img10, img11, img12, img13, img14, img15, img16, img17, img18, img19, img20, newView, selImg1, selImg2;
...
//            Toast.makeText(this, "Tag: " + tag, Toast.LENGTH_SHORT).show();
            ...
            switch (tag) {
                ...
                case 6: newView.setImageResource(R.drawable.i5);
                    break;
                case 7: newView.setImageResource(R.drawable.i7);
                    break;
                case 9: newView.setImageResource(R.drawable.i9);
                    break;
                case 10: newView.setImageResource(R.drawable.i6);
                    break;
                case 11: newView.setImageResource(R.drawable.i11);
                    break;
                case 13: newView.setImageResource(R.drawable.i13);
                    break;
            }
